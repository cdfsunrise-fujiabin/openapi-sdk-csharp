...
namespace openapi_sdk.Utils
{
    public static class RsaUtil
    {
        ...
        /// <returns></returns>
        public static RSACryptoServiceProvider LoadPrivateKey(string privateKeyStr, string keyFormat = "PKCS8")
        {
            string signType = "RSA";
        ...
        {
            publicKeyPem = publicKeyPem.Replace("-----BEGIN RSA PUBLIC KEY-----", "").Replace("-----END RSA PUBLIC KEY-----", "");
